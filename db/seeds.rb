...
# The original hearts, as the site-wide "Hearts" emote set, for a fresh
...
if Emote.none?
  hearts = EmoteSet.site_wide.find_or_create_by!(name: "Hearts") { |emote_set| emote_set.position = 0 }
